package br.com.fences.ocorrenciaespelhobackend.config.listener;
...
/**
 * Depende da configuracao no servidor da propriedade JNDI 'ocorrenciaespelhobackend'
 *
 */
@WebListener
public class ConfiguracaoDaAplicacaoContextListener implements ServletContextListener {
	...
	private static final String APP_NOME = "ocorrenciaespelhobackend";
